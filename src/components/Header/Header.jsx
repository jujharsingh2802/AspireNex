              ...
              item.active ? (
                <li key={item.name} className='sm:mr-4'>
                  <button
                   ...
                   className='inline-block md:font-[Noto Sans]  sm:font-bold px-3 sm:px-6 py-1 sm:py-2 duration-200 hover:bg-blue-100 dark:text-white dark:hover:text-black rounded-full' >
                    {item.name}
                  </button>
                </li>
              ) : null
